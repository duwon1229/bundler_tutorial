/*!
 * 
 *         Build Date: 2021. 11. 2. 오후 10:06:25
 *         commit Version: 20f7ad6
 * 
 *         Author: duwon1229
 * 
 *       
...
var task = __webpack_require__(27).set;
...
if (!setTask || !clearTask) {
  ...
  // Node.js 0.8-
  if (__webpack_require__(4)(process) == 'process') {
    defer = function (id) {
...
var global = __webpack_require__(1);
var macrotask = __webpack_require__(27).set;
var Observer = global.MutationObserver || global.WebKitMutationObserver;
var process = global.process;
var Promise = global.Promise;
var isNode = __webpack_require__(4)(process) == 'process';
...
var es6_promise = __webpack_require__(23);
...
var es6_array_map = __webpack_require__(60);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es6.function.name.js
var es6_function_name = __webpack_require__(69);

// EXTERNAL MODULE: ./node_modules/axios/index.js
var axios = __webpack_require__(38);
var axios_default = /*#__PURE__*/__webpack_require__.n(axios);

// CONCATENATED MODULE: ./src/result.js
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return axios_default.a.get("/api/users");

            case 2:
              res = _context.sent;
              return _context.abrupt("return", (res.data || []).map(function (user) {
                return "<div>".concat(user.id, ": ").concat(user.name, "</div>");
              }).join("-"));
...
var resultEl;
var formEl;
document.addEventListener("DOMContentLoaded", /*#__PURE__*/app_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
  return regeneratorRuntime.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          formEl = document.createElement("div");
          formEl.innerHTML = src_form.render();
          document.body.appendChild(formEl);
          resultEl = document.createElement("div");
          _context.next = 6;
          return src_result.render();

        case 6:
          resultEl.innerHTML = _context.sent;
